...
export default function AdminDashboard() {
  ...
  const navigationItems = [
    ...
    { name: 'Employees', href: '/admin/employees', icon: Users, active: false },
    { name: 'Departments', href: '/admin/departments', icon: Building, active: false },
    { name: 'Recruitment', href: '/admin/recruitment', icon: Briefcase, active: false },
    { name: 'Performance', href: '/admin/performance', icon: TrendingUp, active: false },
    { name: 'Training', href: '/admin/training', icon: GraduationCap, active: false },
    { name: 'Payroll', href: '/admin/payroll', icon: DollarSign, active: false },
                  ...
                  <div className="p-6 bg-white border-2 border-gray-100 rounded-xl">
                    ...
                    <div className="space-y-4">
                      {recentActivities.map((activity) => (
                        ...
                        >
                          <div className="flex-shrink-0 w-10 h-10 bg-black rounded-full flex items-center justify-center text-white font-bold font-['Montserrat']">
